            ...
            <Link href="/" className="flex-shrink-0">
              <div className="text-center">
                <div className="text-2xl font-bold">
                  <span className="text-black">SHUKAN</span>
                </div>
                <div className="text-lg font-bold">
                  <span className="text-red-600">MALL</span>
                </div>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative flex">
                <Input
                  ...
                  className="w-48 rounded-l-md border-red-600"
                />
                <button className="text-white px-3 rounded-r-md bg-red-600 hover:bg-red-700 transition-colors" suppressHydrationWarning>
                  <Search size={16} />
                </button>
              </div>
              ...
              <Link href="/wishlist" className="relative">
                <Heart size={22} className="text-red-600 hover:opacity-80 transition-opacity" />
                {wishlistCount > 0 && (
              ...
              <Link href="/cart" className="relative">
                <ShoppingCart size={22} className="text-red-600 hover:opacity-80 transition-opacity" />
                {cartCount > 0 && (
                  <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                    {cartCount}
                  </span>
